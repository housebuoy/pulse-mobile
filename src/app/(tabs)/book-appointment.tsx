    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <Animated.ScrollView
        ...
        <View style={styles.cardsWrapper}>
          ...
          <HospitalCard name="KNUST University Hospital" location="University Road, Kumasi • Open 24/7" distance="2.5 km" waitStatus="Low Wait" nextSlot="10:30 AM" rating="4.8 (120+)" imageUrl="https://images.unsplash.com/photo-1587351021759-3e566b6af7cc?q=80&w=2000&auto=format&fit=crop" onPress={() => {}} />
          <HospitalCard name="Komfo Anokye Teaching" location="Bantama, Kumasi • Referral Center" distance="4.2 km" waitStatus="Moderate Wait" nextSlot="2:15 PM" rating="4.5 (850+)" imageUrl="https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?q=80&w=2000&auto=format&fit=crop" onPress={() => {}} />
          <HospitalCard name="HopeXchange Medical" location="Santasi, Kumasi • Specialist Care" distance="1.8 km" waitStatus="High Wait" nextSlot="Tomorrow" rating="4.9 (56)" imageUrl="https://images.unsplash.com/photo-1538108149393-fbbd81895907?q=80&w=2000&auto=format&fit=crop" onPress={() => {}} />
        </View>
      </Animated.ScrollView>
